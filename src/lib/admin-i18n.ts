...
export const adminLabels = {
  ...
  contractors: { en: "Contractors", te: "సభ్యులు" },
  ...
  registrationCounts: { en: "Registered by Category", te: "పని వారీ నమోదు" },
  contractorsByCategory: { en: "Contractors List", te: "సభ్యుల లిస్టు" },
  ...
  searchRegistry: { en: "Search contractors", te: "సభ్యులు వెతకండి" },
  noSearchResults: { en: "No contractors match your search", te: "మీ వెతకడానికి ఎవరు లేరు" },
  ...
  mobileNavContractors: { en: "Staff", te: "సభ్యులు" },
